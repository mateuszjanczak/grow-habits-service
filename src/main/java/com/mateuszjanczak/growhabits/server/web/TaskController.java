...
public class TaskController {
    ...
    public ResponseEntity<Void> test(){
        TaskRequest taskRequest = new TaskRequest("przykładowy tytuł", 60L, Arrays.asList(new OptionRequest("tak", 50, "#00FF00"), new OptionRequest("nie", 50, "#FF0000")));
        ...
        task.setOptionList(Arrays.asList(new Option("Yes", 10, "#00FF00"), new Option("No", 10, "#FF0000")));
        taskRepository.save(task);
